    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-column">
          ...
          <ul className="footer-list">
            ...
            <li><a href="https://www.eventbrite.com/l/eventbrite-app/">EventNexus Mobile Ticket App</a></li>
      ...
      <div className="footer-bottom">
        ...
        <div className="select-container">
          <select aria-labelledby="global-footer-select-label" className="eds-field-styled__input eds-field-styled__select" id="global-footer-select" name="global-footer-select">
